const NavBar = () => {
  ...
  return (
    <div className="bg-[#282C33] fixed top-0 z-50 flex lg:space-x-10 md:space-x-10 sm:space-x-7 space-x-7 justify-center w-full py-6 lg:text-xl md:text-xl sm:text-sm pb-1 ">
